...
const styles = StyleSheet.create({
    ...
    chatButton: {
        borderWidth: 1, borderColor: colors.myMessageColor, height: vh * 5, width: vw * 30, borderRadius: vh * 3,
        alignItems: 'center', justifyContent: 'center', flexDirection: 'row', alignSelf: 'center', marginTop: vh * 4
    },
    chatText: {
        color: colors.myMessageColor
    },
    chatIcon: {
        height: vh * 2, width: vh * 2, tintColor: colors.myMessageColor, marginLeft: vw * 4
    }
});
